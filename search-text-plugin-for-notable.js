...
*****************************************************/
var markInstance = new Mark(document.querySelector('.monaco-editor-wrapper.layout-content.editor'));
...
document.querySelector('.monaco-editor-wrapper.layout-content.editor').insertAdjacentHTML('afterBegin',`
...
window.search = function (searchPhrase) {
    ...
    selectedMarkCount = document.querySelectorAll('.monaco-editor-wrapper.layout-content.editor mark').length;
